...
def run_once(out_dir="satellite_out", lookback_days=3, chunk_days=15, mgp_chunk_days=5, request_delay=0.3):
...
def main():
    ...
    ap.add_argument("--mgp-chunk-days", type=int, default=int(os.environ.get("MGP_CHUNK_DAYS", "5")),
